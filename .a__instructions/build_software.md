The following system describes how to use the Orchestrator-Workers pattern to create a blog post:
...
Here is the source code for the blog writing system:
```python
...
Please create a detailed, colorful, Mermaid Sequence diagram that describes this system.  I want to cut and paste your solution into a Mermaid Diagram Editor so that I can see the resulting diagram.
