The following code is using mock calls to the openai api.  I want you to rewrite it to use live calls to the openai api:
```python
...
Please use your browsing tool to find out what the latest syntax is used to make those openai api calls..
